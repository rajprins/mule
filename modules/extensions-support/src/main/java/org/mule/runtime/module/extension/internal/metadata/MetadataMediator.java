...
public final class MetadataMediator<T extends ComponentModel> {
  ...
  public MetadataResult<ParameterMetadataDescriptor> getInputMetadata(MetadataContext context, MetadataKey key, String parameterName) {
    try {
      Object resolvedKey = keyIdObjectResolver.resolve(key);
      ...
      if (parameterModel.isPresent()) {
        return inputDelegate.getParameterMetadataDescriptor(parameterModel.get(), context, resolvedKey);
      }
      ...
      if (successCallbackInputDelegate.isPresent()) {
        parameterModel = ((SourceModel) component).getSuccessCallback().get()
                ...
                .findFirst();
        if (parameterModel.isPresent()) {
          return successCallbackInputDelegate.get().getParameterMetadataDescriptor(parameterModel.get(), context, resolvedKey);
        }
      }
      ...
      if (errorCallbackInputDelegate.isPresent()) {
        parameterModel = ((SourceModel) component).getErrorCallback().get()
                ...
                .findFirst();
        if (parameterModel.isPresent()) {
          return errorCallbackInputDelegate.get().getParameterMetadataDescriptor(parameterModel.get(), context, resolvedKey);
        }
      }
